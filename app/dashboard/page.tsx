  ...
  return (
    <div className="min-h-screen bg-[#F5F2EC] text-neutral-900 pb-20">
      ...
      <div className="bg-white border-b-2 border-black py-4 px-4 sm:px-6 mb-6">
        <div className="max-w-5xl mx-auto flex flex-wrap items-center justify-between gap-4">
          <div className="flex items-center gap-6">
            <div>
              <p className="text-[11px] font-extrabold text-neutral-800 uppercase tracking-wider">Total Tautan</p>
              <p className="text-xl font-black text-black">{totalSlugs}</p>
            </div>
            <div className="h-8 w-[2px] bg-black" />
            <div>
              <p className="text-[11px] font-extrabold text-neutral-800 uppercase tracking-wider">Total Kunjungan</p>
              <p className="text-xl font-black text-violet-700">{totalVisits}</p>
            </div>
          </div>
      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6">
        ...
        {slugsError && (
          <div className="rounded-xl bg-red-100 border-2 border-red-500 p-3 text-red-900 font-bold text-sm mb-6">
        ...
        {slugs && slugs.length === 0 && (
          <div className={`rounded-2xl bg-white p-10 text-center ${hardBorder} ${hardShadow} my-12`}>
            ...
            <h3 className="text-lg font-black mb-1 text-black">Belum ada link dibuat</h3>
            <p className="text-xs text-neutral-800 mb-5 font-semibold max-w-xs mx-auto">Mulai buat link pertama Anda untuk WhatsApp, Short URL, atau Link Bio.</p>
        ...
        {slugs && slugs.length > 0 && (
          <div className="space-y-6">
            ...
            <div className="sticky top-14 z-40 bg-[#F5F2EC] border-b-2 border-black py-3 -mx-4 px-4 sm:mx-0 sm:px-0">
              <div className="flex items-center gap-2 overflow-x-auto pb-1 no-scrollbar">
                <a href="#section-whatsapp" className="px-3.5 py-1.5 rounded-xl bg-emerald-200 border-2 border-black font-black text-xs text-emerald-950 shadow-[2px_2px_0_0_#111] shrink-0">
                  💬 WhatsApp ({whatsappSlugs.length})
                </a>
                <a href="#section-linktree" className="px-3.5 py-1.5 rounded-xl bg-blue-200 border-2 border-black font-black text-xs text-blue-950 shadow-[2px_2px_0_0_#111] shrink-0">
                  🌐 Link Bio ({linktreeSlugs.length})
                </a>
                <a href="#section-shorturl" className="px-3.5 py-1.5 rounded-xl bg-amber-200 border-2 border-black font-black text-xs text-amber-950 shadow-[2px_2px_0_0_#111] shrink-0">
                  🔗 Short URL ({shorturlSlugs.length})
                </a>
                <a href="#section-paste" className="px-3.5 py-1.5 rounded-xl bg-purple-200 border-2 border-black font-black text-xs text-purple-950 shadow-[2px_2px_0_0_#111] shrink-0">
                  📄 Paste & Notes ({pasteSlugs.length})
                </a>
              </div>
            </div>

            {/* Sections with scroll-mt to prevent being hidden under sticky nav */}
            <div className="space-y-8 pt-4">
              {whatsappSlugs.length > 0 && (
                <div id="section-whatsapp" className="space-y-2.5 scroll-mt-28">
                  <h3 className="text-sm font-black uppercase tracking-wider text-black bg-emerald-100 px-3 py-1.5 rounded-lg border-2 border-black inline-block shadow-[2px_2px_0_0_#111]">
              ...
              {linktreeSlugs.length > 0 && (
                <div id="section-linktree" className="space-y-2.5 scroll-mt-28">
                  <h3 className="text-sm font-black uppercase tracking-wider text-black bg-blue-100 px-3 py-1.5 rounded-lg border-2 border-black inline-block shadow-[2px_2px_0_0_#111]">
              ...
              {shorturlSlugs.length > 0 && (
                <div id="section-shorturl" className="space-y-2.5 scroll-mt-28">
                  <h3 className="text-sm font-black uppercase tracking-wider text-black bg-amber-100 px-3 py-1.5 rounded-lg border-2 border-black inline-block shadow-[2px_2px_0_0_#111]">
              ...
              {pasteSlugs.length > 0 && (
                <div id="section-paste" className="space-y-2.5 scroll-mt-28">
                  <h3 className="text-sm font-black uppercase tracking-wider text-black bg-purple-100 px-3 py-1.5 rounded-lg border-2 border-black inline-block shadow-[2px_2px_0_0_#111]">
